            ...
            <div className='footer-main'>
                ...
                <div className='box' data-aos="flip-right"
                    ...
                    <div>
                        ...
                        <a href="https://www.fiverr.com/ameerhamza2090" className='link-web' target='blank' >
                ...
                <div className='box' data-aos="flip-right"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16" style={{ margin: '20px 0px' }}>
