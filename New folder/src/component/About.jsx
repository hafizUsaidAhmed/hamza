  ...
  return (
    <div className='text-light About' id='About'>
      <div className="aboutContainer ">
        ...
        <div className='aboutContant' data-aos="zoom-out-down" data-aos-duration="3000">
      ...
      <div className='ServicesContainer'>
        ...
        <div className='service'>
          ...
          <div className="myServicesCards" data-aos="flip-left"
            ...
            data-aos-duration="2000">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-wordpress serviceIcon" viewBox="0 0 16 16">
